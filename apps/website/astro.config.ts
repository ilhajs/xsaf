...
const nimbusConfig = defineNimbusConfig({
  site: "https://xsaf.ilha.build",
  title: "XSAF",
  description: "A small, fetch-native TypeScript framework for building secure AI agents.",
  locale: "en",
  github: "https://github.com/ilhajs/xsaf",
  editPattern: "https://github.com/ilhajs/xsaf/edit/main/apps/website/src/content/docs/{path}",
  socialImageAlt: "XSAF documentation preview",
});
